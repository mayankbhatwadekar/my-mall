    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder viewHolder, int position) {
        switch (homePageModelList.get(position).getType()) {
            ...
            case HomePageModel.HORIZONTAL_PRODUCT_VIEW:
                ...
                ((HorizontalProductViewHolder) viewHolder).setHorizontalProductLayout(horizontalProductScrollModelList,horizontalLayoutTitle,layout_color,viewAllProductList);
                break;
    ...
    public class StripAdBannerViewHolder extends RecyclerView.ViewHolder {
        ...
        private void setStripAd(String resource, String color) {
            Glide.with(itemView.getContext())
                    .load(resource).apply(new RequestOptions()
                    .placeholder(R.mipmap.image_not_found)).into(stripAdImage);
    ...
    public class GridProductViewHolder extends RecyclerView.ViewHolder{
        ...
        private void setGridProductLayout(final List<HorizontalProductScrollModel> horizontalProductScrollModelList, final String title, String color){
            ...
            for(int x=0;x<4;x++){
                ...
                Glide.with(itemView.getContext()).load(horizontalProductScrollModelList.get(x).getProductImage()).apply( new RequestOptions().placeholder(R.mipmap.image_not_found)).into(productImage);
